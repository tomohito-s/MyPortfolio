  ...
  <main>
    <section id="content_1" class="sec">
      <div class="container">
        ...
        <p class="sec_btn">
          <a href="/wordpress/category/feature/" class="btn btn-default">特徴の一覧</a>
        </p>
      </div>    
    </section>
    ...
    <section id="content_2" class="sec">
      <div class="container">
          ...
          <?php if( $plan_query->have_posts() ): ?>        
            <?php while( $plan_query->have_posts() ) : $plan_query->the_post(); ?>        
              <article class="row content_2-plan">
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 col-sx-12 tumbnail_img">
                  <a href="<?php the_permalink(); ?>">
                    <?php if( has_post_thumbnail() ): ?>
                      <?php the_post_thumbnail('large'); ?>
                    <?php else: ?>
        ...
        <p class="sec_btn">
          <a href="/wordpress/plan/" class="btn btn-default">プランの一覧</a>
        </p>
      </div>    
    </section>
