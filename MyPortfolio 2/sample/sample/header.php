        ...
        <ul>
          ...
          <li class="has-child"><a href="#">About</a>
            <ul>
              ...
              <li><a href="#"><dl><dt><img src="<?php echo get_template_directory_uri() ?>/assets/img/style.jpg" alt=""></dt><dd>Style</dd></dl></a></li>
              <li><a href="#"><dl><dt><img src="<?php echo get_template_directory_uri() ?>/assets/img/gallery.jpg" alt=""></dt><dd>HairGallery</dd></dl></a></li>
              <li><a href="#"><dl><dt><img src="<?php echo get_template_directory_uri() ?>/assets/img/access.jpg" alt=""></dt><dd>Access</dd></dl></a></li>
            </ul>
          </li>
          <li class="has-child"><a href="#">Service</a>
            <ul>
              <li><a href="#"><dl><dt><img src="<?php echo get_template_directory_uri() ?>/assets/img/menu.jpg" alt=""></dt><dd>Menu</dd></dl></a></li>
              <li><a href="#"><dl><dt><img src="<?php echo get_template_directory_uri() ?>/assets/img/reserv.jpg" alt=""></dt><dd>Reservation</dd></dl></a></li>
              <li><a href="#"><dl><dt><img src="<?php echo get_template_directory_uri() ?>/assets/img/items.jpg" alt=""></dt><dd>Items</dd></dl></a></li>
